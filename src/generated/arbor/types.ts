...
export interface ArborEvent_ViewCreated {
  type: 'view_created';
  sourceTreeId: UUID;
  viewTreeId: UUID;
}

export interface ArborEvent_RangeAdded {
  type: 'range_added';
  rangeNodeId: UUID;
  viewTreeId: UUID;
}

export interface ArborEvent_TextRunsDetected {
  type: 'text_runs_detected';
  runs: TextRun[];
  treeId: UUID;
}

export interface ArborEvent_ViewCollapsed {
  type: 'view_collapsed';
...
export interface ArborEvent_RangeContent {
  type: 'range_content';
...
export interface ArborEvent_Error {
  type: 'error';
  message: string;
}
...
export type RangeContent = RangeContent_Text | RangeContent_Reference | RangeContent_Custom;

/** Merged text content */
export interface RangeContent_Text {
  type: 'text';
  content: string;
  nodeCount: number;
  nodeIds: UUID[];
...
export interface RangeContent_Reference {
  type: 'reference';
  endNode: UUID;
  nodeCount: number;
  startNode: UUID;
...
export interface RangeContent_Custom {
  type: 'custom';
  metadata: unknown;
  nodeCount: number;
  strategy: string;
