...
export type ContentBlock = ContentBlock_Text | ContentBlock_ToolUse | ContentBlock_ToolResult | ContentBlock_Thinking;

/** Text content */
export interface ContentBlock_Text {
  type: 'text';
  text: string;
}

/** Tool use */
export interface ContentBlock_ToolUse {
  type: 'tool_use';
  id: string;
  input: unknown;
  name: string;
...
/** Tool result */
export interface ContentBlock_ToolResult {
  type: 'tool_result';
  content: string;
  isError: boolean;
  toolUseId: string;
...
/** Thinking block */
export interface ContentBlock_Thinking {
  type: 'thinking';
  thinking: string;
}
...
export type GetTreeResult = GetTreeResult_Ok | GetTreeResult_Error;

export interface GetTreeResult_Ok {
  type: 'ok';
  head: UUID;
  treeId: UUID;
}

export interface GetTreeResult_Error {
  type: 'error';
  message: string;
}
...
export type RenderResult = RenderResult_Ok | RenderResult_Error;

export interface RenderResult_Ok {
  type: 'ok';
  messages: ClaudeMessage[];
}

export interface RenderResult_Error {
  type: 'error';
  message: string;
}
...
export type SessionsDeleteResult = SessionsDeleteResult_Ok | SessionsDeleteResult_Error;

export interface SessionsDeleteResult_Ok {
  type: 'ok';
  deleted: boolean;
  sessionId: string;
}

export interface SessionsDeleteResult_Error {
  type: 'error';
  message: string;
}
...
export type SessionsExportResult = SessionsExportResult_Ok | SessionsExportResult_Error;

export interface SessionsExportResult_Ok {
  type: 'ok';
  sessionId: string;
  treeId: UUID;
}

export interface SessionsExportResult_Error {
  type: 'error';
  message: string;
}
...
export type SessionsGetResult = SessionsGetResult_Ok | SessionsGetResult_Error;

export interface SessionsGetResult_Ok {
  type: 'ok';
  eventCount: number;
  events: unknown[];
  sessionId: string;
...
export interface SessionsGetResult_Error {
  type: 'error';
  message: string;
}
...
export type SessionsImportResult = SessionsImportResult_Ok | SessionsImportResult_Error;

export interface SessionsImportResult_Ok {
  type: 'ok';
  sessionId: string;
  treeId: UUID;
}

export interface SessionsImportResult_Error {
  type: 'error';
  message: string;
}
...
export type SessionsListResult = SessionsListResult_Ok | SessionsListResult_Error;

export interface SessionsListResult_Ok {
  type: 'ok';
  sessions: string[];
}

export interface SessionsListResult_Error {
  type: 'error';
  message: string;
}
